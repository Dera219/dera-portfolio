...
export const content = {
  ...
  projects: [
    ...
    },
    {
      ...
      blurb:
        "A research platform for relative signals — panel data, a composable signal algebra, a vectorised backtester with square-root market impact, and validation built to kill results before I believe them. Its causality checker proves a signal cannot see the future: perturb every observation after time t, recompute, and assert nothing before t moved. That catches full-sample normalisation, the lookahead bug that survives review because it looks like the textbook. I logged every defect found after the tests were already green — thirteen, and twelve made results look better than reality.",
      learned:
